...
const post = `Over the past few weeks, I've been playing through the latest title from Rockstar Games, L.A. Noire. It's an adventure game interspersed with some driving and shooting sections, but the real reason to play it is the characters.
