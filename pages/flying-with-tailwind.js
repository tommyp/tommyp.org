...
const P = ({children}) => {
  return <p className="text-4xl font-open-sans text-blue-600 leading-relaxed">
    {children}
  </p>
}

const Section = ({children}) => {
  return <section className="ml-48 flex-col space-y-8">
    {children}
  </section>
}

const H2 = ({children}) => {
  return <h2 className="font-archivo-black transform -skew-x-12 border-l-200 md:border-l-400 border-blue-600 text-blue-600 mb-8 pl-10 text-6xl sm:text-7xl xl:-ml-64 uppercase">{children}</h2>
}

const A = ({href, children}) => {
  return <a href={href} className="text-white bg-blue-600 inline-block transform -skew-x-12">{children}</a>
}

const Pre = ({children}) => {
  return <pre className="font-mono bg-gray-400 rounded-md inline px-2">{children}</pre>
}

const Code = ({children}) => {
  return <code className="font-mono bg-gray-400 text-blue-600 text-4xl p-8 rounded-md block">
    {children}
  </code>
}
...
const AnIntroToTailwind = () => {
  return (
    <>
      ...
      <div className="w-full bg-blue-600 pb-20">
        <Header textColor="text-white" borderColor="border-white" />
        <h1 className="text-6xl sm:text-7xl md:text-8xl xl:text-10xl text-white uppercase font-bold font-archivo-black xl:-ml-12  w-full overflow-hidden leading-none">
            <div className="block -ml-32 md:-ml-64 lg:-ml-40">
              <span className="block transform -skew-x-12 border-l-200 md:border-l-400 lg:border-l-600 border-white mb-8 pl-10">Flying</span>
              <span className="block transform -skew-x-12 border-l-200 md:border-l-400 lg:border-l-600 border-white mb-8 pl-10 -ml-8">With</span>
      ...
      <main className="w-11/12 mx-auto flex flex-col space-y-20 py-20">
        <Section>
      ...
      <H2>
        ...
        <Section>
          ...
          <Code>
            &lt;a href="/testimonials" className="text-gray-900 hover:underline hover:text-black-900"&gt;<br/>
            &nbsp;&nbsp;Testimonials<br/>
            &lt; /a&gt;
          </Code>
        ...
        <H2>Wrapping up</H2>
        <Section>
          <P>Tailwind is a CSS framework to build your own design system, which ships with sensible defaults to generate a good starting point. Give it a shot with your next project and see how it goes. You might not believe it&apos;s as good as people say without trying it. As the fantastic docs say:</P>
          <blockquote className="text-4xl text-blue-600 border-l-8 border-blue-600 pl-10 italic">
        ...
        <Section>
          <small className="text-gray-700 text-sm font-open-sans">Published 27th March 2021</small>
        </Section>
      </main>
    </>
  )
