      ...
      <main className="mt-20">
        ...
        <article className="mx-auto w-10/12 lg:w-1/2 xl:w-1/3 mt-20 font-rubik text-2xl leading-normal">
          ...
          <ul className="mb-10">
            ...
            <Li>📝 <ExtA href="https://www.ithoughtaboutthatalot.com/">I Thought About That A Lot</ExtA> - a series of essays which includes a really touching story <ExtA href="https://www.ithoughtaboutthatalot.com/how-to-dispose-of-a-body">about disposing of a body</ExtA> and <ExtA href="https://www.ithoughtaboutthatalot.com/why-caroline-quentin-isnt-more-famous">thoughts on Caroline Quentin&apos;s career</ExtA>.</Li>

            <Li>🎧 Many Twitch DJ streams from my friends, with a simultaneous Zoom call to chat and see familiar faces.</Li>
          </ul>
